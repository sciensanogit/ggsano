...
sciensano_col_d <-
  c("midgreen" = rgb(red = 58, green = 170, blue = 53, maxColorValue = 255),
    ...
    "orange" = rgb(red = 242, green = 213, blue = 0, maxColorValue = 255),
...
### continuos colours
#### GREEN
colfunc <- colorRampPalette(c("#00441B", "#F7FCF5"))
...
## save data
usethis::use_data(sciensano_col_d, line_df, internal = TRUE, overwrite = TRUE)
